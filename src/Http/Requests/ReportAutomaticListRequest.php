...
class ReportAutomaticListRequest extends FormRequest implements SortableParams, PaginatableParams
{
    use PaginatableRequestParamsTrait;
    use SortableRequestParamsTrait;
    use SearchableRequestParamsTrait;

    private ReportAutomaticListParams $params;
    ...
    public function getParams(): ReportAutomaticListParams
    {
        return $this->params;
    }
    ...
    private function initParams(): void
    {
        ...
        $this->params = new ReportAutomaticListParams(
